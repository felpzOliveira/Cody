...
#if 0
"        result += texture(sampler, uv + vec2(1,1)   * texelSize);\n"
"        result += texture(sampler, uv + vec2(1,-1)  * texelSize);\n"
"        result += texture(sampler, uv + vec2(-1,1)  * texelSize);\n"
"        result += texture(sampler, uv + vec2(-1,-1) * texelSize);\n"
"        result += texture(sampler, uv + vec2(2,1)   * texelSize);\n"
"        result += texture(sampler, uv + vec2(2,-1)  * texelSize);\n"
"        result += texture(sampler, uv + vec2(-2,1)  * texelSize);\n"
"        result += texture(sampler, uv + vec2(-2,-1) * texelSize);\n"
"        result += texture(sampler, uv + vec2(1,2)   * texelSize);\n"
"        result += texture(sampler, uv + vec2(1,-2)  * texelSize);\n"
"        result += texture(sampler, uv + vec2(-1,2)  * texelSize);\n"
"        result += texture(sampler, uv + vec2(-1,-2) * texelSize);\n"
"        result += texture(sampler, uv + vec2(2,2)   * texelSize);\n"
"        result += texture(sampler, uv + vec2(2,-2)  * texelSize);\n"
"        result += texture(sampler, uv + vec2(-2,2)  * texelSize);\n"
"        result += texture(sampler, uv + vec2(-2,-2) * texelSize);\n"
