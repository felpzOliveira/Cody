...
"    return uv;\n"
"}\n"
"vec4 eval_texture(vec2 uv, vec2 texSize){\n"
"    if(zoomLevel < 1.02){\n"
"        const int d_radius = 1;\n"
"        vec4 result = vec4(0);\n"
"        vec2 texelSize = 1.0 / texSize;\n"
#if 0
"        result += texture2D(image0, uv + vec2(1,1)   * texelSize);\n"
"        result += texture2D(image0, uv + vec2(1,-1)  * texelSize);\n"
"        result += texture2D(image0, uv + vec2(-1,1)  * texelSize);\n"
"        result += texture2D(image0, uv + vec2(-1,-1) * texelSize);\n"
"        result += texture2D(image0, uv + vec2(2,1)   * texelSize);\n"
"        result += texture2D(image0, uv + vec2(2,-1)  * texelSize);\n"
"        result += texture2D(image0, uv + vec2(-2,1)  * texelSize);\n"
"        result += texture2D(image0, uv + vec2(-2,-1) * texelSize);\n"
"        result += texture2D(image0, uv + vec2(1,2)   * texelSize);\n"
"        result += texture2D(image0, uv + vec2(1,-2)  * texelSize);\n"
"        result += texture2D(image0, uv + vec2(-1,2)  * texelSize);\n"
"        result += texture2D(image0, uv + vec2(-1,-2) * texelSize);\n"
"        result += texture2D(image0, uv + vec2(2,2)   * texelSize);\n"
"        result += texture2D(image0, uv + vec2(2,-2)  * texelSize);\n"
"        result += texture2D(image0, uv + vec2(-2,2)  * texelSize);\n"
"        result += texture2D(image0, uv + vec2(-2,-2) * texelSize);\n"
...
"                fragColor = eval_texture(uv, imageSize);\n"
"            }\n"
"        }\n"
"    }else{\n"
...
"            imageColor = eval_texture(uv, imageSize);\n"
"        }\n"
"    }\n"
