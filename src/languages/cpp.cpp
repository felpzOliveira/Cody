/* Build from 'C:/Users/Felpz/Documents/Cody/lang_tables/lang_cpp' */
/* Contextual content */
/////////////////////////////////
#include <languages.h>
...
std::vector<std::vector<GToken>> cppReservedPreprocessor = {
    ...
    {
        { .value = "OPTIX_SUCCESS", .identifier = TOKEN_ID_RESERVED },
        { .value = "OptixDenoiser", .identifier = TOKEN_ID_DATATYPE },
    ...
    {
        { .value = "OptixDenoiserSizes", .identifier = TOKEN_ID_DATATYPE },
        { .value = "OptixDeviceContext", .identifier = TOKEN_ID_DATATYPE }, },
    {
        { .value = "OptixDenoiserParams", .identifier = TOKEN_ID_DATATYPE }, },
    {
        { .value = "OptixDenoiserOptions", .identifier = TOKEN_ID_DATATYPE }, },
    {
